...
class OSM1_Shipping_Alopeyk extends OSM1_Shipping_Base {

    /**
     * Constructor
     */
    public function __construct($instance_id = 0) {
        $this->id = 'osm1_alopeyk';
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                'title' => __('فعال', 'osm1'),
                'type' => 'checkbox',
                'label' => __('فعال کردن الوپیک', 'osm1'),
                'default' => 'yes',
            ),
            'title' => array(
                'title' => __('عنوان', 'osm1'),
    ...
    protected function get_shipping_method_description() {
        return __('ارسال از طریق الوپیک', 'osm1');
    }
    ...
    protected function calculate_shipping_cost($package) {
        ...
        if ($cost === false) {
            ...
            $cost = floatval($this->cost) + ($distance * 2000);
        }
